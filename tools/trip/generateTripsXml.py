...
@date    2009-02-09
@version $Id: generateTripsXml.py 13811 2013-05-01 20:31:43Z behrisch $
...
def main(options):
    ...
    print >> fouttrips, """<!-- generated on %s by $Id: generateTripsXml.py 13811 2013-05-01 20:31:43Z behrisch $ -->
